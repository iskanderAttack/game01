      ...
      <div className="scroll">
        ...
        <div className="card stack">
          <Segmented
            ...
            options={[
              { value: 'rich', label: 'Объёмная', emoji: '🧊' },
              { value: 'fast', label: 'Плоская', emoji: '🔲' },
            ]}
          />
          <div className="setting-hint">
            {quality === 'fast'
              ? qualityAuto
                ? 'Доска стала плоской сама: телефон не успевал рисовать объёмную. Вернуть можно в любой момент — но если снова начнёт мигать, переключитесь обратно.'
                : 'Вся доска целиком, простыми квадратиками: цвет группы, чей участок, сколько домов и где фишки. Названия и цены открываются касанием клетки. Рисуется в разы легче объёмной — берите этот вид, если телефон подтормаживает.'
              : 'Доска с наклоном и перспективой, камера едет за фишкой, названия улиц читаются прямо на клетках. Если появятся рывки или клетки начнут мигать — переключите на «Плоскую».'}
          </div>
          <div className="setting-hint">
            Тот же переключатель есть прямо под доской во время партии.
          </div>
        </div>
          ...
          <div className="row">
            ...
            <div>
              ...
              <div className="muted" style={{ fontSize: 13 }}>
                Версия 1.1.3 · офлайн и по Wi-Fi
              </div>
            </div>
          </div>
